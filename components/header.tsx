...
export default function Header() {
  return (
    <header className="w-full bg-white/70 backdrop-blur-lg inset-0 fixed z-50 h-24">
      <div className="flex items-center justify-between w-[93%] py-6 sm:px-6 h-fit mx-auto">
